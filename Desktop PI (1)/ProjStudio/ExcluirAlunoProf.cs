...
{
    public partial class ExcluirAlunoProf: Form
    {
        public ExcluirAlunoProf()
        {
            InitializeComponent();
        }
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    try
                    {
                        ClasseAlunoTurma cat = new ClasseAlunoTurma(cod, guna2TextBox1.Text);
                        if (cat.Existe())
                        {
                            if (cat.Exclui())
                            {
                            ...
                            MessageBox.Show("Este Aluno não Pertence a Esta Turma");
                    }
                    catch (Exception ex)
                    {
        ...
        private void ExcluirAlunoProf_Load(object sender, EventArgs e)
        {
