...
namespace ProjStudio
{
    public partial class Professor: Form
    {
        ...
        {
            // Cria o Form 
            ExcluirProf formExcluirProf = new ExcluirProf();
            formExcluirProf.Show();
        ...
        {
            // Cria o Form 
            ConsultaProf formConsultaProf = new ConsultaProf();
            formConsultaProf.Show();
        ...
        {
            // Cria o Form 
            AtualizaProf formAtualizaProf = new AtualizaProf();
            formAtualizaProf.Show();
