...
{
    public partial class CadastroQuest : Form
    {
        public CadastroQuest()
        {
            InitializeComponent();
        }
        ...
        private void CadastroQuest_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        ClasseQuestao cq = new ClasseQuestao(guna2TextBox1.Text, int.Parse(maskedTextBox1.Text), guna2ComboBox1.Text, guna2TextBox2.Text, guna2TextBox3.Text, guna2TextBox4.Text, guna2TextBox5.Text, guna2TextBox6.Text, guna2TextBox7.Text, guna2TextBox8.Text, guna2TextBox9.Text, guna2ComboBox2.Text, foto, 1);
                        if (cq.Cadastro())
                        {
